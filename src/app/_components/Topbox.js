import gettopbox from "../../../servies/topbox";
import Link from "next/link";

const TopShows =async()=>{
    const topfamous = gettopbox();
    const result = await topfamous;
    // console.log(result);
    return(
        <>
              <div className="bg-black relative">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <h2 className="text-2xl font-bold tracking-tight text-white">Top Box Office</h2>
